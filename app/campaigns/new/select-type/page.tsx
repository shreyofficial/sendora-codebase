      ...
      <main className="flex-1 p-6 overflow-auto">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            {/* Scheduled Campaign */}
            <div
              className={`relative overflow-hidden cursor-pointer rounded-xl border border-[#222222] bg-[#0a0a0a] hover:border-gray-500 transition-all duration-300 ${
                selectedType === "scheduled" ? "border-white" : ""
              }`}
              onClick={() => setSelectedType("scheduled")}
            >
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex items-center justify-center w-14 h-14 rounded-full bg-[#111111]">
                    <Clock className="w-7 h-7 text-blue-400" />
                  </div>
                  <div>
                    <h2 className="text-2xl font-bold">Scheduled Campaign</h2>
                    <p className="text-gray-400">Send on your schedule</p>
                  </div>
                </div>
            ...
            <div
              className={`relative overflow-hidden cursor-pointer rounded-xl border border-[#222222] bg-[#0a0a0a] hover:border-gray-500 transition-all duration-300 ${
                selectedType === "realtime" ? "border-white" : ""
              }`}
              ...
              <div className="p-8">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Respond instantly</p>
                  </div>
                </div>
          ...
          <div className="flex justify-center">
            <button
              ...
              className={`px-8 py-3.5 rounded-lg text-base font-medium transition-all duration-300 ${
                selectedType ? "bg-white text-black hover:bg-gray-200" : "bg-[#1a1a1a] text-gray-400 cursor-not-allowed"
              }`}
            >
